...
@external(javascript, "../../../../../src/ct/ct_std", "reflection__get_static_method")
pub fn get_static_method(
  base_class base_class: String,
  method_name method_name: String,
  // a = tuple of arguments
) -> fn(a) -> Result(Option(b), ReflectionError)

@external(javascript, "../../../../../src/ct/ct_std", "reflection__get_field_value")
...
@external(javascript, "../../../../../src/ct/ct_std", "reflection__classof")
pub fn classof(base_obj: a) -> Result(Class, ReflectionError)

@external(javascript, "../../../../../src/ct/ct_std", "reflection__get_private_field_value")
...
@external(javascript, "../../../../../src/ct/ct_std", "reflection__field")
pub fn field(
  field_name: String,
) -> fn(a) -> Result(FieldReflection(b, c), ReflectionError)

@external(javascript, "../../../../../src/ct/ct_std", "reflection__get_priv_value")
pub fn get_priv_value(
  field_name: String,
  // a = the based object to call this on, giving a None will result in getting the static field's value
) -> fn(a) -> Result(b, ReflectionError)

@external(javascript, "../../../../../src/ct/ct_std", "reflection__set_priv_value")
...
@external(javascript, "../../../../../src/ct/ct_std", "reflection__call_method")
pub fn call_method(
  method_name method_name: String,
...
@external(javascript, "../../../../../src/ct/ct_std", "reflection__new_instance")
pub fn new_instance(
  class_name: String,
) -> fn(a) -> Result(Option(b), ReflectionError)
