@external(javascript, "../../../../../src/ct/ct_std", "triggers__register_on_tick")
pub fn register_on_tick(tick_handler _tick_handler: fn() -> Nil) -> Nil

@external(javascript, "../../../../../src/ct/ct_std", "triggers__register_on_post_gui_render")
pub fn register_on_post_gui_render(
  post_gui_render_handler _post_gui_render_handler: fn() -> Nil,
) -> Nil

@external(javascript, "../../../../../src/ct/ct_std", "triggers__every_x_seconds")
